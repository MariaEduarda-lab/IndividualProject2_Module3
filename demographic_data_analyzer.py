...
def calculate_demographic_data(print_data=True):
    ...
    df = pd.read_csv("adult.data.csv") # Defining the dataframe
    ...
    # with and without Bachelors, Masters, or Doctorate (higher and lower education columns)
    ...
    country_rich = (df[df['salary'] == '>50K']['native-country']
